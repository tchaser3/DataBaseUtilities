...
'Description    This form is for logging on the application
...
Public Class Logon
    ...
    Private Sub btnLogon_Click(sender As System.Object, e As System.EventArgs) Handles btnLogon.Click
        ...
        Try
            ...
            MessageBox.Show(mstrFirstName + " " + mstrLastName + " is logged in to Database Utilities Program", "Thank You", MessageBoxButtons.OK, MessageBoxIcon.Information)
